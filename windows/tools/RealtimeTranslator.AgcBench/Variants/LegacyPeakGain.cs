...
/// <summary>
/// v1 契約の再現、比較専用。#161 以前の AdaptiveMicrophoneGain (ピーク追跡) を
/// `git show` そのまま複写したもの。新規コードからは参照しない。
/// </summary>
internal sealed class LegacyPeakGain
{
    ...
    public LegacyPeakGain(float initialGain = DefaultInitialGain)
    {
