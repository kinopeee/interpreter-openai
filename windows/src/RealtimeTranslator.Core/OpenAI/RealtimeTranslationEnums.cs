...
{
    public static string ToWireValue(this RealtimeTranslationOutputLanguage value) =>
        value switch
        {
    ...
    public static string ToWireValue(this RealtimeTranslationNoiseReduction value) =>
        value switch
        {
    ...
    public static string ToWireValue(this RealtimeTranscriptionDelay value) =>
        value switch
        {
    ...
    public static RealtimeTranslationOutputLanguage ParseOutputLanguage(string wireValue) =>
        wireValue switch
        {
    ...
    public static RealtimeTranslationNoiseReduction ParseNoiseReduction(string wireValue) =>
        wireValue switch
        {
    ...
    public static RealtimeTranscriptionDelay ParseTranscriptionDelay(string wireValue) =>
        wireValue switch
        {
