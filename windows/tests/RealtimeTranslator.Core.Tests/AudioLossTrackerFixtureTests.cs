...
public sealed class AudioLossTrackerFixtureTests
{
    public static TheoryData<string> CaseNames
    {
        get
        {
            ...
            foreach (var node in SharedFixtures.Load("audio", version: 2)["loss"]!["cases"]!.AsArray())
            {
    ...
    {
        var loss = SharedFixtures.Load("audio", version: 2)["loss"]!.AsObject();
    ...
    {
        var item = SharedFixtures.Load("audio", version: 2)["loss"]!["cases"]!
            .AsArray()
            .OfType<JsonObject>()
